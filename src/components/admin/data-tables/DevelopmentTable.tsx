...
function CheckTable(props: { tableData: any }) {
  ...
  const columns = [
    columnHelper.accessor('name', {
      id: 'name',
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">اسم الاصل</p>
      ),
      cell: (info) => (
    ...
    columnHelper.accessor('tech', {
      id: 'tech',
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">القسم</p>
      ),
      cell: (info: any) => (
    ...
    columnHelper.accessor('date', {
      id: 'date',
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">تاريخ الجرد</p>
      ),
      cell: (info) => (
        <p className="text-sm font-bold text-navy-700 dark:text-white">
          {info.getValue()}
